...
<div class="d-flex flex-column flex-column-fluid">
    <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6 ">
        ...
        <div id="kt_app_toolbar_container" class="app-container flex-column-fluid">
            <div class="page-title d-flex justify-content-between me-3 ">
                <h1 class="page-heading text-gray-900 fw-bold flex-column my-0">
                    Users List
                </h1>
                <div class="">
    ...
    <div id="kt_app_content" class="app-content  flex-column-fluid ">
        <div id="kt_app_content_container" class="app-container">
            <div class="card">
                <div class="card-header justify-content-center justify-content-lg-between border-0 pt-6">
                    <div class="card-title">
                        <div class="d-flex align-items-center">
                            <div class="d-flex align-items-center position-relative my-1 me-2">
                                ...
                                <input type="text" data-kt-user-table-filter="search" class="form-control form-control-solid w-300px ps-13" placeholder="Search user" />
                            </div>
                        </div>
                    </div>

                    <div class="card-toolbar justify-content-sm-center">
                        <div class="d-flex align-items-center ">
                            <div class="d-flex justify-content-end gap-1 gap-lg-3" data-kt-user-table-toolbar="base">
                                ...
                                <!--begin::Filter-->
                                <button type="button" class="btn btn-outline btn-outline-dashed btn-outline-primary btn-sm" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">
                                ...
                                <!--begin::Export-->
                                <button type="button" class="btn btn-outline btn-outline-dashed btn-outline-primary btn-sm" data-bs-toggle="modal" data-bs-target="#kt_modal_export_users">
                            ...
                            <div class="d-flex justify-content-end align-items-center d-none" data-kt-user-table-toolbar="selected">
                                ...
                                <button type="button" class="btn btn-light-danger btn-sm btn-icon" data-kt-user-table-select="delete_selected">
                ...
                <div class="card-body py-4">
                    ...
                    <!--begin::Table-->
                    <table class="table align-middle table-row-dashed table-hover fs-6" id="kt_table_users">
                        <thead>
                            <tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
                                <th class="w-10px px-0 text-center">
                                    <div class="form-check form-check-sm flex-center form-check-custom form-check-solid">
